						...
						<div class="col-sm-5">
							<select class="form-control" name="brand_id">
								...
								<?php foreach ($brand as $value) {
									if (count($value->sub) > 1) { ?>
										<option value="<?php echo $value->id; ?>" <?php if (set_value('brand_id') == $value->id) echo 'selected'; ?>><?php echo $value->name; ?></option>
										<?php
										foreach ($value->sub as $val) { ?>
											<option value="<?php echo $val->id; ?>" <?php if (set_value('brand_id') == $val->id) echo 'selected'; ?>>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $val->name; ?></option>
										<?php }
										?>
